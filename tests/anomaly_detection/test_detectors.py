...
@pytest.fixture(params=[
    ...
    anomaly_detection.KernelPrincipleComponentAnalysis(15),
    ...
    anomaly_detection.PrincipleComponentAnalysis(15),
    anomaly_detection.RobustPrincipleComponentAnalysis(),
