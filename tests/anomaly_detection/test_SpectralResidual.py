...
class TestMedianMethod:
    ...
    def test_str(self):
        assert str(SpectralResidual(5)) == "SpectralResidual(moving_average_window_size=5)"
        assert str(SpectralResidual(5, epsilon=0.1)) == "SpectralResidual(moving_average_window_size=5,epsilon=0.1)"
    ...
    @pytest.mark.parametrize('moving_average_window_size', [1.0, "0", True, None, ['a', 'list']])
