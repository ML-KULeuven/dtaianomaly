...
class TestKMeansAnomalyDetector:
    ...
    def test_str(self):
        ...
        assert (
            str(KMeansAnomalyDetector("fft"))
            == "KMeansAnomalyDetector(window_size='fft')"
        )
        assert (
            str(KMeansAnomalyDetector(15, 3))
            == "KMeansAnomalyDetector(window_size=15,stride=3)"
        )
        assert (
            str(KMeansAnomalyDetector(25, n_clusters=3))
            == "KMeansAnomalyDetector(window_size=25,n_clusters=3)"
        )
