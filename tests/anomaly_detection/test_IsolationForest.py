...
class TestIsolationForest:
    ...
    def test_str(self):
        ...
        assert (
            str(IsolationForest(25, n_estimators=42))
            == "IsolationForest(window_size=25,n_estimators=42)"
        )
        assert (
            str(IsolationForest(25, max_samples=50))
            == "IsolationForest(window_size=25,max_samples=50)"
        )
