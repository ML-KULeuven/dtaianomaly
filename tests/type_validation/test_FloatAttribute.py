...
class TestFloatAttribute:
    ...
    @pytest.mark.parametrize(
        "minimum", [1, True, "auto", [0, 1, 2, 2], {"a": 1, "b": 2}]
    )
    ...
    @pytest.mark.parametrize(
        "maximum", [1, True, "auto", [0, 1, 2, 2], {"a": 1, "b": 2}]
    )
    ...
    def test_inclusive_minimum_valid(self, inclusive_minimum):
        assert (
            FloatAttribute(inclusive_minimum=inclusive_minimum).inclusive_minimum
            == inclusive_minimum
        )

    @pytest.mark.parametrize(
        "inclusive_minimum", [1, 1.5, "auto", [0, 1, 2, 2], {"a": 1, "b": 2}]
    )
    ...
    def test_inclusive_maximum_valid(self, inclusive_maximum):
        assert (
            FloatAttribute(inclusive_maximum=inclusive_maximum).inclusive_maximum
            == inclusive_maximum
        )

    @pytest.mark.parametrize(
        "inclusive_maximum", [1, 1.5, "auto", [0, 1, 2, 2], {"a": 1, "b": 2}]
    )
    ...
    @pytest.mark.parametrize(
        "minimum,maximum,inclusive_minimum,inclusive_maximum,value,is_valid",
        [
    ...
    def test_is_valid_value(
        self, minimum, maximum, inclusive_minimum, inclusive_maximum, value, is_valid
    ):
        assert (
            FloatAttribute(
                minimum=minimum,
    ...
    def test_get_valid_value_description_only_minimum_inclusive(self, minimum):
        assert (
            FloatAttribute(
                minimum=minimum, inclusive_minimum=True
    ...
    def test_get_valid_value_description_only_minimum_exclusive(self, minimum):
        assert (
            FloatAttribute(
                minimum=minimum, inclusive_minimum=False
            )._get_valid_value_description()
    ...
    def test_get_valid_value_description_only_maximum_inclusive(self, maximum):
        assert (
            FloatAttribute(
                maximum=maximum, inclusive_maximum=True
            )._get_valid_value_description()
    ...
    def test_get_valid_value_description_only_maximum_exclusive(self, maximum):
        assert (
            FloatAttribute(
                maximum=maximum, inclusive_maximum=False
            )._get_valid_value_description()
            == f"less than {maximum}"
        )
    ...
    @pytest.mark.parametrize("minimum", [1.1])
    @pytest.mark.parametrize("maximum", [10.0])
    def test_get_valid_value_description_minimum_and_maximum_inclusive_inclusive(
    ...
    @pytest.mark.parametrize("minimum", [1.1])
    @pytest.mark.parametrize("maximum", [10.0])
    def test_get_valid_value_description_minimum_and_maximum_inclusive_exclusive(
        self, minimum, maximum
    ):
        assert (
            FloatAttribute(
    ...
    @pytest.mark.parametrize("minimum", [1.1])
    @pytest.mark.parametrize("maximum", [10.0])
    def test_get_valid_value_description_minimum_and_maximum_exclusive_inclusive(
        self, minimum, maximum
    ):
        assert (
            FloatAttribute(
    ...
    @pytest.mark.parametrize("minimum", [1.1])
    @pytest.mark.parametrize("maximum", [10.0])
    def test_get_valid_value_description_minimum_and_maximum_exclusive_exclusive(
        self, minimum, maximum
    ):
        assert (
            FloatAttribute(
